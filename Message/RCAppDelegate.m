...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.rootViewController = [RCTool getTabBarController];
//    
//    UITabBar* tabBar = [RCTool getTabBarController].tabBar;
//    UITabBarItem* tbi0 = [[tabBar items] objectAtIndex:0];
//    [tbi0 setFinishedSelectedImage:[UIImage imageNamed:@"text"] withFinishedUnselectedImage:[UIImage imageNamed:@"text"]];
...
//    UIViewController* vc = [[RCTool getTabBarController] viewControllers][1];
//    [vc.view addSubview:_adMobAd];
}
